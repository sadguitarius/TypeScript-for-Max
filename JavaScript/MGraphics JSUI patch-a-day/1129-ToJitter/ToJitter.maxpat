...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.0, 72.0, 256.0, 256.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 337.0, 318.0, 337.0, 318.0, 61.0, 347.5, 61.0 ],
					"source" : [ "obj-3", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				"name" : "ToJitter.js",
				"bootpath" : "/Applications/Max6/testing/NovemberPatches/1129-ToJitter",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
			}
